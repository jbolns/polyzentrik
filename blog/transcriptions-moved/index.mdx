...
We initially categorised our transcription scripts as digital sustainability assets because sustainability commonly involves oral interactions that need to be transcribed.
...
For instance, customer service calls do not necessarily contain a whole lot of PII. PII is involved – names, emails, bank accounts, and similar pieces of data. However, the PII involved is relatively easy to identify. Some providers therefore offer services that automatically remove these specific PII types.

### But, sometimes, very problematic
However, challenges arise when audios contain PII that is not easily removable and/or sensitive or confidential information.
...
Sending all that information to an unknown provider is tantamount to insanity. You could be giving someone what they need to deepfake/impersonate people. Using a reputable provider might be a better option. However, there is still a need for clarity and safeguards about how the data is handled.
...
If you are dealing with sensitive conversations, do not know how your AI transcription provider handles data, or do not have consent to send participants’ data to a cloud-based provider, local transcriptions are the way to go (and, in some cases, comply with applicable regulations).
