...
hero_image: './xai-journeys-shap-prelim.jpeg'
hero_image_alt: 'A risk pyramid containing several different AI explainability/interpretability states.'
...
![An image depicting an AI explainability/interpretability risk pyramind and steps by which to make the model more explainable/interpretable.](xai-journeys-shap-prelim.jpeg 'Figure 1. XAI Journeys - Imaginary SHAP.')
...
### Launching a new project – help us develop open resources
