...
intro: 'We can train your IT team to identify and capitalise on digital sustainability opportunities.'
author: 'J'
...
### Our (open) resources
We have produced a syllabus for a mini-course on digital sustainability. The course is suitable for students, managers, policymakers, and programmers and is available under an open-source license. 

Provided the conditions in the license are met, anyone can implement the syllabus as part of their own training. 

More information about the syllabus is available [here](../../resources/ds-101/). The syllabus is available via [GitHub](https://github.com/jbolns/ds_101).
