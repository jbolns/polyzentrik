...
const ProductsComponent = () => {
    return (
        <Container className='mt-5'>
            ...
            <div className='row shop d-flex'>
                <div className='col-12 col-lg-6 my-1'>
                    <div className='card d-flex' data-sal='slide-up' data-sal-delay='400' data-sal-easing='ease'>
                        <h3 className='px-2 py-3 mb-3 card-title pzntrk small'>Pay for services</h3>
                        ...
                        <a href='https://buy.stripe.com/eVa16F6XJ6XB8PS4gk' target='_blank' rel='noreferrer noopener' className='btn btn-lg border border-dark col-10 offset-1' role='button'>Pay</a>
                        <p className='small text-center capsies'><Link to='/terms-conditions'>Terms & Conditions</Link></p>
                    </div>
               </div>

                <div className='col-12 col-lg-6 my-1'>
                    <div className='card d-flex' data-sal='slide-up' data-sal-delay='400' data-sal-easing='ease'>
                        <h3 className='px-2 py-3 mb-3 card-title pzntrk small'>Pay it forward</h3>
                        ...
                        <a href='https://buy.stripe.com/28o16Fci381F7LOeUX' target='_blank' rel='noreferrer noopener' className='btn btn-lg border border-dark col-10 offset-1' role='button'>Pay</a>
                        <p className='small text-center capsies'><Link to='/terms-conditions'>Terms & Conditions</Link></p>
                    </div>
                </div>
            </div>
